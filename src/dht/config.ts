 ...
 */
export function validateConfig(config: DHTNodeConfig): void {
...
export class DHTConfigBuilder {
  private config: Partial<DHTNodeConfig> = {};
 ...
 */
export function serializeConfig(config: DHTNodeConfig): SerializedConfig {
  return {
 ...
 */
export function deserializeConfig(json: SerializedConfig): DHTNodeConfig {
  const config: DHTNodeConfig = {
