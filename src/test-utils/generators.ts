 ...
 */
export function uint8ArrayArbitrary(
 ...
 */
export function peerIdArbitrary(
 ...
 */
export const listenAddressArbitrary: fc.Arbitrary<string> = fc.constantFrom(
  '/ip4/0.0.0.0/tcp/0',
 ...
 */
export const bootstrapPeerArbitrary: fc.Arbitrary<string> = fc.constantFrom(
  '/ip4/104.131.131.82/tcp/4001/p2p/QmaCpDMGvV2BGHeYERUEnRQAwe3N8SzbUtfsmvsqQLuvuJ',
  '/dnsaddr/bootstrap.libp2p.io/p2p/QmNnooDu7bfjPFoTZYxMNLWUQJyrVwtbZg5gBMjTezGAJN',
  '/ip4/147.75.109.213/tcp/4001/p2p/QmZa1sAxajnQjVM8WjWXoMbmPd7NsWhfKsPkErzpm9wGkp',
 ...
 */
export const stunServerArbitrary: fc.Arbitrary<string> = fc.constantFrom(
 ...
 */
export const turnServerArbitrary: fc.Arbitrary<TurnServer> = fc.record({
  urls: fc.array(
    fc.constantFrom(
 ...
 */
export const webrtcConfigArbitrary: fc.Arbitrary<WebRTCConfig> = fc.record({
  enabled: fc.boolean(),
  stunServers: fc.option(
    fc.array(stunServerArbitrary, { minLength: 1, maxLength: 3 }),
    { nil: undefined }
  ),
  turnServers: fc.option(
    fc.array(turnServerArbitrary, { minLength: 0, maxLength: 2 }),
    { nil: undefined }
  ),
});
 ...
 */
export const circuitRelayConfigArbitrary: fc.Arbitrary<CircuitRelayConfig> = fc.record({
  enabled: fc.boolean(),
 ...
 */
export const protocolArbitrary: fc.Arbitrary<string> = fc.constantFrom(
  '/ipfs/kad/1.0.0',
  '/custom/dht/1.0.0',
  '/oracle-yz/kad/1.0.0'
);
 ...
 */
export const configArbitrary: fc.Arbitrary<DHTNodeConfig> = fc
  .record({
    listenAddresses: fc.array(listenAddressArbitrary, { minLength: 1, maxLength: 5 }),
    announceAddresses: fc.option(
      fc.array(listenAddressArbitrary, { minLength: 1, maxLength: 3 }),
      { nil: undefined }
    ),
    ...
    bootstrapPeers: fc.option(
      fc.array(bootstrapPeerArbitrary, { minLength: 0, maxLength: 3 }),
      { nil: undefined }
    ),
 ...
 */
export const minimalConfigArbitrary: fc.Arbitrary<DHTNodeConfig> = fc
 ...
 */
export function dhtKeyArbitrary(
  options: { length?: number } = {}
): fc.Arbitrary<Uint8Array> {
  const { length = 32 } = options;
  return fc.uint8Array({ minLength: length, maxLength: length });
 ...
 */
export function dhtValueArbitrary(
  options: { minLength?: number; maxLength?: number } = {}
): fc.Arbitrary<Uint8Array> {
 ...
 */
export const keyValuePairArbitrary: fc.Arbitrary<{ key: Uint8Array; value: Uint8Array }> = fc.record({
  key: dhtKeyArbitrary(),
 ...
 */
export function peerIdArrayArbitrary(
  options: { minLength?: number; maxLength?: number; peerIdLength?: number } = {}
): fc.Arbitrary<Uint8Array[]> {
