...
import {
  ...
  dhtKeyArbitrary,
  dhtValueArbitrary,
  keyValuePairArbitrary,
  peerIdArrayArbitrary,
  listenAddressArbitrary,
  bootstrapPeerArbitrary,
} from './generators.js';
...
describe('Test Utility Generators', () => {
  describe('uint8ArrayArbitrary', () => {
    it('generates Uint8Arrays within specified length range', () => {
      fc.assert(
        fc.property(
          uint8ArrayArbitrary({ minLength: 10, maxLength: 20 }),
          (arr) => {
  ...
  describe('peerIdArrayArbitrary', () => {
    it('generates arrays of peer IDs', () => {
      fc.assert(
        fc.property(
          peerIdArrayArbitrary({ minLength: 5, maxLength: 10 }),
          (peerIds) => {
